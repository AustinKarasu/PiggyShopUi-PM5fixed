...
use DaPigGuy\PiggyShopUI\ItemTypeIds;
...
class PiggyShopUI extends PluginBase
{
    ...
    {
        $banner = StringToItemParser::getInstance()->parse("minecraft:banner");
        if ($banner !== null && $item->getTypeId() === $banner->getTypeId()) {
            $colors = ["Black", "Red", "Green", "Brown", "Blue", "Purple", "Cyan", "Light Gray", "Gray", "Pink", "Lime", "Yellow", "Light Blue", "Magenta", "Orange", "White"];
